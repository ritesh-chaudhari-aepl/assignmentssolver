...
const Page = () => {
  return (
    <div className="p-4  max-w-screen-2xl mx-auto pt-16">
      ...
      <p className="p-2 font-sans text-base">
        Assignment Solver.com reserves the right to modify this privacy
        statement any time, so please review it frequently. Any changes made to
        above policy will be posted here and your continued use of the site,
        services and/or software constitutes your agreement to be bound by such
        changes.
      </p>
      <p className="p-2 font-sans text-base">
