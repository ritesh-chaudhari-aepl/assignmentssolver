...
const Sessions = () => {
  return (
    <section id="sessions" className="bg-gradient-to-r from-dark1 to-dark2">
      <div className="mx-auto max-w-screen-xl mt-16 sm:mt-0 py-14 sm:py-24">
        <div>
          <div className=" mb-24">
            <h3 className="text-white capitalize text-3xl font-bold sm:text-4xl leading-[50px] px-3 sm:px-0 text-center sm:leading-[60px] mb-6">
              online sessions with the best tutors
            </h3>
            <p className="text-white capitalize text-sm font-Inter font-[400] text-center leading-[30px] sm:text-base sm:leading-[27px] sm:px-0 px-6">
