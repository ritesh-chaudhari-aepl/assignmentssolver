...
const CustomCard = ({ icon, bgColor, badgeCount, iconColor, title }) => {
  return (
    <div className={`card  shadow-sm bg-darkBg rounded-md w-[180px] h-[160px] flex flex-col justify-center items-center`}>
      {icon && (
      ...
      <p className="font-[500] text-sm text-center px-3 text-white">{title}</p>
    </div>
  );
};
