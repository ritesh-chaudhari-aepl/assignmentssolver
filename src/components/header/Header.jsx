...
function Header({ myRef }) {
  ...
  return (
    <header
      className={`${
        isActive
          ? "top-0 z-30 sm:top-0 sm:py-4 bg-darkBg shadow-2xl overflow-hidden"
          : "top-0 sm:top-0 py-10"
      } py-4 sm:py-0 fixed w-full transition-all z-10 bg-darkBg`}
    >
      <div className="mx-auto max-w-screen-2xl lg:max-w-screen-xl md:px-4 py-3 px-2 flex justify-between items-center">
        {/* logo */}
        <a href="#">
          {/* <span className="font-Inter font-bold tracking-[10px] text-2xl uppercase sm:text-[30px]">
            LOGO
          </span> */}
          <Image src={logo} className="md:w-40 w-24" alt="logo" />
        </a>
        ...
        <div className="flex">
          <a
            href="https://wa.me/message/CNLWDR65L3GIH1"
            className="flex gap-2 items-center rounded-full bg-gradient-to-r from-pink-darkPink to-blue-light md:px-8 md:py-4 px-2 py-3 text-sm font-medium text-white transition hover:bg-indigo-700 capitalize"
          >
